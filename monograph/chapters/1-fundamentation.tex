		...
		\label{sec.inter-cluster-communication}
			...
			\label{sec.mailbox-abs}
				...
				\begin{figure}[t]
					...
					\subfloat[Conceptual Overview.]{
						{\includegraphics[width=.6\linewidth]{images/mailbox-logical.pdf} }
					}%

					\subfloat[Flow of execution: Slave sends a message, Master reads and notifies the sender.]{
						{\includegraphics[width=.8\linewidth]{images/mailbox-flow.pdf} }
					}%
			...
			\label{sec.portal-abs}
				...
				\begin{figure}[t]
					\centering
					\caption{Portal Abstraction: Node 1 create a portal and notify Node 2 to transfer the data.}
