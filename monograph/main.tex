...
\titulo{Development of Modules of a Hardware Abstraction Layer for the Kalray MPPA-256 Lightweight Manycore Processor}
% \subtitulo{}
...
\coorientador{Mr.}{Pedro Henrique}{Penna}{Université Grenoble Alpes}
...
\addbibresource{bib.bib} % {biblatex} package
...
% \input{chapters/3-development.tex}
