...
\coordenador{José Francisco D. de G. C. Fletes}
...
\coorientador{Me.}{Pedro Henrique}{Penna}{Université Grenoble Alpes}
...
\membroBanca{Prof. Dr. Rômulo Silva de Oliveira}{Universidade Federal de Santa Catarina}
\membroBanca{Prof. Dr. Odorico Machado Mendizabal}{Universidade Federal de Santa Catarina}
...
\palavrasChave{{HAL}, {Sistema Operacional}, {\textit{Lightweight Manycore}}, {Kalray MPPA-256}}
\palavrasChave[english]{{HAL}, {Operating System}, {Lightweight Manycore}, {Kalray MPPA-256}}
...
% \imprimircapa
\imprimirfolhaderosto % \imprimirfolhaderosto* (o * indica que haverá a ficha bibliográfica)
...
\input{chapters/1-fundamentation.tex}
\input{chapters/2-related-works.tex}
 \input{chapters/3-proposal.tex}
