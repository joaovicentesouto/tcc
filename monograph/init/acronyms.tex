...
%S
	\newacronym[plural=SRAMs,firstplural=Static Random Access Memories (SRAMs)]{sram}{SRAM}{Static Random Access Memory}
	\newacronym[plural=SPMs,firstplural=Scratchpad Memories (SPMs)]{spm}{SPM}{Scratchpad Memory}
	
%T
    \newacronym{test}{TEST}{This is a Test}
    \newcommand{\test}{\gls{test}\xspace}
    \newcommand{\tests}{\glspl{test}\xspace}
