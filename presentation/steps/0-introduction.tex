	...
	\begin{frame}{Historical Evolution and Trend of Processors}
		\begin{overprint}
			\only<1>{
				...
				\begin{center}
					Increase in \textbf{processor performance}
				\end{center}
			}
			\only<2>{
		...
		% #########
		% O crescente ganho de desempenho dos processadores ao decorrer dos anos foi limitado pelas altas temperaturas causas pelo aumento de frequência.
		% O avanço tecnologico dos semicondutores e componentes do processador amenizaram essa limitação.
	\end{frame}
