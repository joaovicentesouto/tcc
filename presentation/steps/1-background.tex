\section{Background}
	...
	\subsection{Nanvix OS}
		...
		\begin{frame}[fragile]{Nanvix HAL}
			...
			% Ela é a primeira camada acima do hardware e prove uma visão padronizada dos processadores.
			% Ela é composta por níveis que lidam com características de um núcleo, de todos os núcleos, e entre clusters.
