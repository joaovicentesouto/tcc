...
\titulo{An Inter-Cluster Communication Facility for Lightweight Manycore Processors in the Nanvix OS}
...
% do \begin{document}
\input{init/acronyms.tex}
\input{init/glossary.tex}
\input{init/commands.tex}
