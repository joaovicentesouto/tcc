...
\todo[inline]{Na real, os trabalhos relacionados propoe sistemas para
manycore apenas. O diferencial é que o Nanvix olha para as
arquiteturas lightweight.}
...
\section{Discussion}
	...
	\todo[inline]{Na minha visao, aqui cabe um paragrafo adicional. Em
		comparacao com os sistemas anteriores, o Nanvix visa manycores
			com uma NoC onde a programacao é explicita. Os demais
			trabalham com plataformas NUMA, onde existe um barramento
			complexo, mas nao há de fato "network prgramming". Acho que
	value ressaltar isso e os desafios envolvidos.}
