...
\label{sec.works.manycores}
	...
	\citeonline{Wallentowitz2013} presents the open-source \optimsoc
	...
	Similarly, \citeonline{Kurth2017} introduce the \hero, which unites an \arm
...
\label{sec.works.os}
	...
	In \citeonline{Wisniewski2014} \etal, the concept of scalability was pushed
