...
\label{sec.nanvix}
	...
	\label{sec.hal}
		...
		\begin{figure}[!tb]
			...
			\includegraphics[width=.5\textwidth]{nanvix-hal-overview.pdf}%
	...
	\label{sec.microkernel}
		...
		\begin{figure}[!tb]
			...
			\includegraphics[width=.5\textwidth]{nanvix-microkernel-overview.pdf}%
			\fonte{Adapted from \citeonline{penna:sbesc19}}%
		\end{figure}
		...
		\begin{figure}[!tb]
			...
			\includegraphics[width=.9\textwidth]{nanvix-microkernel-execution.pdf}%
