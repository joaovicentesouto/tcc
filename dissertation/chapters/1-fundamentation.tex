	...
	\label{sec.multiprocessors}
		...
		\label{sec.multiprocessor-hw}
			...
			\begin{figure}[t]
				...
				\subfloat[Single Instruction Single Data.]{{\includegraphics[width=.3\linewidth]{images/sisd.pdf} }}%
				\qquad
				\subfloat[Single Instruction Multiple Data.]{{\includegraphics[width=.3\linewidth]{images/simd.pdf} }}%

				\subfloat[Multiple Instruction Single Data.]{{\includegraphics[width=.3\linewidth]{images/misd.pdf} }}%
				\qquad
				\subfloat[Multiple Instruction Multiple Data.]{{\includegraphics[width=.3\linewidth]{images/mimd.pdf} }}%

				% \\ \vspace{0.3cm}
				Source: Adapted from \cite{url:flynn}.
		...
		\label{sec.multiprocessor-os}
			...
			\begin{figure}[t]
				...
				\includegraphics[width=.6\textwidth]{images/replicated-os.pdf}
			...
			\begin{figure}[t]
				...
				\includegraphics[width=.6\textwidth]{images/master-slave-os.pdf}
			...
			\begin{figure}[t]
				...
				\includegraphics[width=.6\textwidth]{images/symmetric-os.pdf}
		...
		\label{sec.inter-cluster-communication}
			...
			\label{sec.sync-abs}
				...
				\begin{figure}[t]
					...
					\subfloat[N Slaves notify the Master.]{{\includegraphics[width=.8\linewidth]{images/sync-create.pdf} }}%

					\subfloat[The Master notify N Slaves.]{{\includegraphics[width=.8\linewidth]{images/sync-open.pdf} }}%
			...
			\label{sec.mailbox-abs}
				...
				\begin{figure}[t]
					...
					\subfloat[Conceptual Overview.]{{\includegraphics[width=.6\linewidth]{images/mailbox-logical.pdf} }}%

					\subfloat[Flow of execution: Slave sends a message, Master reads and notifies the sender.]{{\includegraphics[width=.8\linewidth]{images/mailbox-flow.pdf} }}%
