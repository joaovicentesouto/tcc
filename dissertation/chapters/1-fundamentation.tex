...
\label{sec.nanvix}
	...
	\begin{figure}[!tb]
		...
		\includegraphics[width=.8\textwidth]{three-p.pdf}%
	...
	\label{sec.microkernel}
		...
		\begin{figure}[!tb]
			...
			\includegraphics[width=.85\textwidth]{microkernel-struct.png}%
			\fonte{\citeonline{url:nanvix-microkernel}.}%
		\end{figure}
	...
	\label{sec.multikernel}
		...
		\begin{figure}[!tb]
			...
			\label{fig:microkernel-struct}%
			\includegraphics[width=.8\textwidth]{multikernel-struct.png}%
			\fonte{Adapted from \citeonline{Baumann2009}.}%
		\end{figure}
