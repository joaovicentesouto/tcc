...
\label{sec.nanvix}
	...
	even if the implementation in practice is directed to manycores processors.
		...
		\todo[inline]{
			Insert here a paragraph describing the types of applications aims to support by Nanvix
		}
	...
	% The \microkernel, above the \hal, follows the Master-Slave \os model to avoid
	% cache coherence problems present in many manycores.
	...
	\label{sec.microkernel}
		...
		\begin{figure}[t]
			...
			\includegraphics[width=.8\textwidth]{microkernel-struct.png}%
	...
	\label{sec.hal}
		...
		to \mppa~\cite{DeDinechin2013-1}.
			\todo[inline]{It is more about a specific part of the HAL.}
