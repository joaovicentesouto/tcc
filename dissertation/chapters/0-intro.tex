...
\label{sec.goals.main}
	...
	\textit{\nanvix \microkernel}. This work is part of the collaborative
...
\label{sec.goals.specific}
	...
	\begin{itemize}
		...
		\item Implementation of the proposed interface in the \textit{Nanvix \hal} for the \mppa lightweight manycore processor;
        
		\item Integration of the Nanvix \hal interface with the \textit{Nanvix \microkernel};
		
		\item Performance evaluation of Nanvix \microkernel implementation using synthetic micro-benchmarks that reproduce the \textit{collective communication routines} of the \mpi programming model.
	\end{itemize}
...
\label{sec.organization}
	...
	\autoref{ch.background} details the background of this work.
