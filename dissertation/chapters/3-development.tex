...
\label{ch.development}
	...
	\label{sec.low-level-comm}
		...
		\label{sec.general-concepts}
			...
			or kernels have \todo{used what?}{used it}. Thus, we must ensure a standard behavior
			...
			lazy transfer, where the \todo{?}{master saves the parameters if not
...
% % Desafios da implementação
					...
					interrupt, (ii) interrupts preempted by \todo{others what?}{others} cannot find the \dnoc
					resources that issued the interrupt, and (iii) \todo{who?}{cannot} verify the
...
% Fluxo da operação
			...
			the receiver sets the \todo{what is readout?}{readout} and notifies the sender. In this way,
